...
public class NGrinderControllerStarter {
	 ...
	 */
	@Parameter(names = {"-ast", "--auto-scale-type"}, description = "agent auto scale - type : aws only")
	...
	@Parameter(names = {"-aspi", "--auto-scale-private-ip"}, description = "agent auto scale - true if private ip is used.")
