...
public interface AgentDynamicConstants {
	public static final String PROP_AGENT_DYNAMIC_TYPE = "agent.dynamic_type";
	public static final String PROP_AGENT_DYNAMIC_AWS_IDENTITY = "agent.dynamic_aws_identity";
