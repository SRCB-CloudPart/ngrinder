...
3. Docker should be installed in the machine of the mesos cluster.

4. The mesos software should be launched with "docker" as part of the configuration of "--containerizers" in slave machine of the cluster.